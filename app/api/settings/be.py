...
def _to_out(be: ZBizEntityDB) -> BizEntityOut:
    return BizEntityOut(
        ...
        payroll_account_number=be.payroll_account_number,
        province=be.province,
        country=be.country,
        street_address=be.street_address,
        city=be.city,
        postal_code=be.postal_code,
        phone=be.phone,
        email=be.email,
        wsib_number=be.wsib_number,
        eht_account=be.eht_account,
        remittance_frequency=be.remittance_frequency,
        tax_year_end=be.tax_year_end,
        legal_name=be.legal_name,
        operating_name=be.operating_name,
        business_type=be.business_type,
        incorporation_date=be.incorporation_date,
        employee_count=be.employee_count,
        stripe_customer_id=be.stripe_customer_id,
        stripe_subscription_id=be.stripe_subscription_id,
        stripe_price_id=be.stripe_price_id,
        stripe_status=be.stripe_status,
        stripe_current_period_end=be.stripe_current_period_end,
        stripe_cancel_at_period_end=be.stripe_cancel_at_period_end,
        stripe_cancel_at=be.stripe_cancel_at,
        stripe_plan_key=be.stripe_plan_key,
        stripe_interval=be.stripe_interval,
        stripe_latest_event_id=be.stripe_latest_event_id,
    )
